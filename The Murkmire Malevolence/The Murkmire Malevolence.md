...
The note is signed, "[Dr. Cassee Dannell](https://5e.tools/bestiary.html#dr.%20cassee%20dannell_kftgv)."
...
Dr. Dannell (neutral good, human [commoner](https://5e.tools/bestiary.html#commoner_mm)) has an Intelligence score of 18. She anxiously addresses the characters:
...
[![Dr. Cassee Dannell|528](https://5e.tools/img/adventure/KftGV/006-01-003.dr-cassee-dannell.webp)](https://5e.tools/img/adventure/KftGV/006-01-003.dr-cassee-dannell.webp "Dr. Cassee Dannell. Art credit: Nikki Dawes")

[Dr. Cassee Dannell](https://5e.tools/bestiary.html#dr.%20cassee%20dannell_kftgv)
...
The characters must wear formal dress to the gala. Dr. Dannell has an appropriate outfit for each character in her heirloom [bag of holding](https://5e.tools/items.html#bag%20of%20holding_dmg). Dr. Dannell lends the bag to the characters to store their adventuring gear, which they'll need while sneaking about the museum after hours.
...
For bringing the Murkmire Stone back to Dr. Dannell, she offers her [bag of holding](https://5e.tools/items.html#bag%20of%20holding_dmg) plus 20 gp per character. If a character succeeds on a DC 13 Charisma (Persuasion) check, Dr. Dannell increases her offer to 30 gp per character.

[![Map 1.1: Players' Map|412](https://5e.tools/img/adventure/KftGV/007-01-004.players-map.webp)](https://5e.tools/img/adventure/KftGV/007-01-004.players-map.webp "Map 1.1: Players' Map. Art credit: Francesca Baerald")

---
# The Opening Gala

The private gala celebrating the opening of the Murkmire Stone exhibition begins at 6 p.m., and the museum closes at 8 p.m. There's enough time for characters to prepare before attending, including retrieving or procuring formal attire if they don't wish to wear the clothes Dr. Dannell provided. Weapons and visible armor are not permitted inside the museum and must be stashed in Dr. Dannell's [bag of holding](https://5e.tools/items.html#bag%20of%20holding_dmg) or elsewhere.

Once the characters are ready to enter the museum, keep track of which character has the [bag of holding](https://5e.tools/items.html#bag%20of%20holding_dmg) that contains the group's adventuring gear. Then read the following aloud:
...
The characters can explore the public areas of the museum while it's open. The entire museum is public except for its offices (areas [V5](https://5e.tools/adventure.html#kftgv,1,v5%3a%20curator's%20office,0)–[V7](https://5e.tools/adventure.html#kftgv,1,v9%3a%20underground%20wonders%20exhibit,0)), basement ([area V16](https://5e.tools/adventure.html#kftgv,1,v16%3a%20basement,0)), and attic ([area V17](https://5e.tools/adventure.html#kftgv,1,v17%3a%20attic,0)).

The characters have about two hours to prepare for their heist before the museum closes. If the characters don't immediately go to the Gemstone Wing ([area V13](https://5e.tools/adventure.html#kftgv,1,v13%3a%20gemstone%20wing,0)), museum guards notice their formal attire and periodically suggest they do so.

Information relevant to the characters' heist plan is below. More information about specific areas of the museum is included in the "[Museum Locations](https://5e.tools/adventure.html#kftgv,1,museum%20locations,0)" section later.

### Entering Nonpublic Areas

The doors to the museum's offices (areas V5–V7) and basement (area V16) are locked at all hours, as described in the "Interior Doors" subsection of the "[General Features](https://5e.tools/adventure.html#kftgv,1,general%20features,0)" section. Curator Alda Arkin, whom the characters might meet at the gala, carries a master key, while the museum's guards have keys that grant access to specific areas (see "[Circumventing Security](https://5e.tools/adventure.html#kftgv,1,circumventing%20security,0)" and "[Curator Alda Arkin](https://5e.tools/adventure.html#kftgv,1,curator%20alda%20arkin,0)").
...
If one or more characters are spotted in a restricted area or cause a public incident, a [guard](https://5e.tools/bestiary.html#guard_mm) approaches them. Roll on the Museum Guards table to determine which guard arrives. Characters in formal dress are escorted to the Gemstone Wing, while characters who are improperly dressed for the occasion are told to leave the museum at once. If the characters protest, the guard becomes hostile and shouts for backup. At the end of each of the guard's turns, an additional 1d4 [guards](https://5e.tools/bestiary.html#guard_mm) arrive until all the museum guards are accounted for.
...
Alarms. Audible [alarm](https://5e.tools/spells.html#alarm_phb) spells have been cast in areas marked (A) on [map 1.2](https://5e.tools/adventure.html#kftgv,1,map%201.2%3a%20dm's%20map,0). The museum's guards and the curator have pass cards that allow them to bypass these alarms, and spare pass cards are kept in [area V7](https://5e.tools/adventure.html#kftgv,1,v7%3a%20break%20room%20and%20storage,0) (see "[Bypassing Alarms](https://5e.tools/adventure.html#kftgv,1,circumventing%20security,0)" below for more information). The alarms are located as follows:

- The front doors to [area V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0)
- At the bottom of the stairs in [area V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0)
- In each hallway leading from [area V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0) to [area V3](https://5e.tools/adventure.html#kftgv,1,v3%3a%20ancient%20plants%20exhibit,0)
- On the doors leading from [area V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0) to areas [V5](https://5e.tools/adventure.html#kftgv,1,v5%3a%20curator's%20office,0), [V6](https://5e.tools/adventure.html#kftgv,1,v6%3a%20records%20room,0), and [V7](https://5e.tools/adventure.html#kftgv,1,v7%3a%20break%20room%20and%20storage,0)
- In the hall leading from [area V11](https://5e.tools/adventure.html#kftgv,1,v11%3a%20unearthed%20caf%c3%a9,0) to [area V12](https://5e.tools/adventure.html#kftgv,1,v12%3a%20prehistoric%20predators%20exhibit,0)
- On the door leading from [area V12](https://5e.tools/adventure.html#kftgv,1,v12%3a%20prehistoric%20predators%20exhibit,0) to the hallway to [area V13](https://5e.tools/adventure.html#kftgv,1,v13%3a%20gemstone%20wing,0)
...
The characters can find a record of the museum's payment for these spells, including their specific locations, by searching the records room (area V6); the alarms can also be detected using [detect magic](https://5e.tools/spells.html#detect%20magic_phb). The alarms aren't armed while the museum is open to the public.

Animated Statues. The statues that flank the front desk in [area V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0) and the statue next to the stairs in [area V12](https://5e.tools/adventure.html#kftgv,1,v12%3a%20prehistoric%20predators%20exhibit,0) can animate after hours to attack intruders. These statues use the [animated armor](https://5e.tools/bestiary.html#animated%20armor_mm) stat block. Causing a statue to animate alerts any guards in that area.

A [detect magic](https://5e.tools/spells.html#detect%20magic_phb) spell reveals an aura of transmutation magic around each statue. A character who becomes aware of the statues' magical nature can make a DC 10 Intelligence (Arcana) check. If the check is successful, the character realizes the statues can animate.

Gemstone Wing. If the characters don't carefully remove the Murkmire Stone from its pedestal in area V13, [arcane lock](https://5e.tools/spells.html#arcane%20lock_phb) spells cause all doors leading to the room (including secret doors) to close and lock. As an action, a character can either try to unlock a door using thieves' tools, doing so with a successful DC 20 Dexterity check, or force open the door by succeeding on a DC 20 Strength (Athletics) check. The characters can learn about this security measure by attending the gala (see the "[Attending the Gala](https://5e.tools/adventure.html#kftgv,1,attending%20the%20gala,0)" section).

Guards. After hours, Maryam Bikram is stationed at the entrance to the gala. Eleven other museum guards watch the areas indicated in the Guard Locations After Hours table. Guards have keys to certain areas. Guards also have pass cards that allow them to bypass the museum's alarms (see "[Bypassing Alarms](https://5e.tools/adventure.html#kftgv,1,circumventing%20security,0)" below).

If the characters get into a noisy fight with one or more guards, an additional 1d4 [guards](https://5e.tools/bestiary.html#guard_mm) arrive each round until all the remaining museum guards are accounted for.
...
|Area|Guards|
|---|---|
|[V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0)|2|
|[V3](https://5e.tools/adventure.html#kftgv,1,v3%3a%20ancient%20plants%20exhibit,0)|1|
|[V4](https://5e.tools/adventure.html#kftgv,1,v4%3a%20ancient%20cultures%20exhibit,0)|1|
|[V8](https://5e.tools/adventure.html#kftgv,1,v8%3a%20creatures%20of%20the%20past%20exhibit,0)|1|
|[V9](https://5e.tools/adventure.html#kftgv,1,v9%3a%20underground%20wonders%20exhibit,0)–[V10](https://5e.tools/adventure.html#kftgv,1,v10%3a%20archaeology%20display,0)|2|
|[V11](https://5e.tools/adventure.html#kftgv,1,v11%3a%20unearthed%20caf%c3%a9,0)|1|
|[V12](https://5e.tools/adventure.html#kftgv,1,v12%3a%20prehistoric%20predators%20exhibit,0)|2|
|[V13](https://5e.tools/adventure.html#kftgv,1,v13%3a%20gemstone%20wing,0)|2|
...
- Bypassing Alarms. The curator and guards each carry a palm-sized pass card embossed with the museum's logo. A [detect magic](https://5e.tools/spells.html#detect%20magic_phb) spell reveals an aura of divination magic around each pass card, which allows the bearer to bypass any of the museum's alarms. The characters can find a stash of extra pass cards in [area V7](https://5e.tools/adventure.html#kftgv,1,v7%3a%20break%20room%20and%20storage,0). A character who is hidden and within reach of a guard can try to steal that guard's pass card without the guard's knowledge, doing so with a successful DC 14 Dexterity (Sleight of Hand) check.
- Sneaking Past Guards. The characters can find a document in the curator's office ([area V5](https://5e.tools/adventure.html#kftgv,1,v5%3a%20curator's%20office,0)) that outlines the guards' stations after hours. During the gala, the curator keeps this document on her person (see the "[Curator Alda Arkin](https://5e.tools/adventure.html#kftgv,1,curator%20alda%20arkin,0)" section). Characters who spend at least 1 minute studying the document have advantage on Dexterity (Stealth) checks made to sneak past guards after hours.
- Stealing Keys. The curator carries a master key, while each guard carries a key that unlocks all doors to the area in which the guard is stationed. Guards in [area V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0) also have a key to the break room ([area V7](https://5e.tools/adventure.html#kftgv,1,v7%3a%20break%20room%20and%20storage,0)). A character can steal a guard's key in the same way as they can steal a pass card, described in "Bypassing Alarms" above.

[![The Murkmire Stone is the primary treasure on display during the Varkenbluff Museum's opening gala|450](https://5e.tools/img/adventure/KftGV/008-01-005.murkmire-stone-display.webp)](https://5e.tools/img/adventure/KftGV/008-01-005.murkmire-stone-display.webp "The Murkmire Stone is the primary treasure on display during the Varkenbluff Museum's opening gala. Art credit: Irina Nordsol")

### Hiding in the Museum

The characters can hide in numerous locations while the museum closes. Below are good options, which are detailed in the "[Museum Locations](https://5e.tools/adventure.html#kftgv,1,museum%20locations,0)" section:

- Cleaning Supply Storage. Short hallways that hold cleaning supplies are concealed behind secret doors in areas [V3](https://5e.tools/adventure.html#kftgv,1,v3%3a%20ancient%20plants%20exhibit,0), [V4](https://5e.tools/adventure.html#kftgv,1,v4%3a%20ancient%20cultures%20exhibit,0), [V8](https://5e.tools/adventure.html#kftgv,1,v8%3a%20creatures%20of%20the%20past%20exhibit,0), [V9](https://5e.tools/adventure.html#kftgv,1,v9%3a%20underground%20wonders%20exhibit,0), [V12](https://5e.tools/adventure.html#kftgv,1,v12%3a%20prehistoric%20predators%20exhibit,0), and [V13](https://5e.tools/adventure.html#kftgv,1,v13%3a%20gemstone%20wing,0).
- Privies. The guards nominally check [area V15](https://5e.tools/adventure.html#kftgv,1,v15%3a%20privies,0) before closing, but anyone who hides here avoids detection.
- Attic or Basement. The guards don't enter areas [V16](https://5e.tools/adventure.html#kftgv,1,v16%3a%20basement,0) or [V17](https://5e.tools/adventure.html#kftgv,1,v17%3a%20attic,0) before the museum closes.
...
- Front Doors. The characters could pick the lock on the front doors to [area V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0), use pass cards to bypass the alarm (see "[Bypassing Alarms](https://5e.tools/adventure.html#kftgv,1,circumventing%20security,0)"), and contend with the falling net trap just inside the doors while remaining a safe distance from the animated statues.
...
If the characters approach the private gala in the Gemstone Wing ([area V13](https://5e.tools/adventure.html#kftgv,1,v13%3a%20gemstone%20wing,0)), they encounter Maryam Bikram (lawful neutral, human [guard](https://5e.tools/bestiary.html#guard_mm)). The captain of the museum's security force, Maryam is a serious woman and a veteran of the city's watch. She admits any character who is dressed for the occasion and has a ticket. Others are turned away.
...
Twenty other gala attendees (unarmed and unarmored [nobles](https://5e.tools/bestiary.html#noble_mm)) mill around the event. All are dressed in elaborate finery, and most are long-time donors to the museum.
...
Mingling with the gala's attendees is Alda Arkin (neutral evil, elf [noble](https://5e.tools/bestiary.html#noble_mm)), the museum's curator. During the gala, the curator is unarmed and unarmored. A retired university professor, Alda is responsible for the museum's close ties to Varkenbluff University's anthropology and archaeology departments.
...
Alda's Clutch. Characters who watch Alda closely notice a fancy clutch she holds behind her back. Inside the clutch is a map of the museum guards' after-hours stations, a master key to the museum's locked doors, and a pass card that allows Alda to bypass the museum's alarms (see "[Investigating Security Measures](https://5e.tools/adventure.html#kftgv,1,investigating%20security%20measures,0)" earlier in the adventure for details).

### Examining the Murkmire Stone

The Murkmire Stone sits atop a pedestal in [area V13](https://5e.tools/adventure.html#kftgv,1,v13%3a%20gemstone%20wing,0), flanked by informational placards about the stone's discovery and theories about its use—though Dr. Dannell's occult theory is missing.
...
Once the Murkmire Stone exhibition gala ends, the museum closes. Its staff members activate the protections listed in the "[Investigating Security Measures](https://5e.tools/adventure.html#kftgv,1,investigating%20security%20measures,0)" section.
...
- Interior Doors. The interior doors are closed and locked, with the exception of the privies in [area V15](https://5e.tools/adventure.html#kftgv,1,v15%3a%20privies,0). A character can use an action to try to unlock a door using thieves' tools, doing so with a successful DC 12 Dexterity check unless otherwise noted. Attempting to use thieves' tools to unlock a door with an enabled [alarm](https://5e.tools/spells.html#alarm_phb) spell triggers that alarm.
- Lighting. On the first two floors, most areas are lit with [continual flame](https://5e.tools/spells.html#continual%20flame_phb) spells placed on sconces. The grand entrance ([area V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0)), Prehistoric Predators exhibit ([area V12](https://5e.tools/adventure.html#kftgv,1,v12%3a%20prehistoric%20predators%20exhibit,0)), basement ([area V16](https://5e.tools/adventure.html#kftgv,1,v16%3a%20basement,0)), and attic ([area V17](https://5e.tools/adventure.html#kftgv,1,v17%3a%20attic,0)) are areas of dim light. Guards in areas [V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0) and [V12](https://5e.tools/adventure.html#kftgv,1,v12%3a%20prehistoric%20predators%20exhibit,0) carry hooded lanterns.
...
[![Map 1.2: DM's Map|429](https://5e.tools/img/adventure/KftGV/009-map-1.02-dms-map.webp)](https://5e.tools/img/adventure/KftGV/009-map-1.02-dms-map.webp "Map 1.2: DM's Map. Art credit: Francesca Baerald")

[![Player Version|427](https://5e.tools/img/adventure/KftGV/010-map-1.02-dms-map-player.webp)](https://5e.tools/img/adventure/KftGV/010-map-1.02-dms-map-player.webp "Player Version. Art credit: Francesca Baerald")
### V1: Grand Entrance
...
Two [guards](https://5e.tools/bestiary.html#guard_mm) patrol this area. The two statues flanking the information desk animate if a character comes within 5 feet of either of them. The statues use the [animated armor](https://5e.tools/bestiary.html#animated%20armor_mm) stat block and fight until destroyed.

Alarms. An [alarm](https://5e.tools/spells.html#alarm_phb) spell has been cast on the bottom of the grand staircase. Another such spell has been cast on the front doors.
...
The first time a creature steps on the pressure plate while the trap is activated, a weighted net drops from a secret compartment in the ceiling, covering the 10-foot-square area between the front doors and the information desk. Creatures in that area are [restrained](https://5e.tools/conditionsdiseases.html#restrained_phb) by the net, and those that fail a DC 10 Strength saving throw are also knocked [prone](https://5e.tools/conditionsdiseases.html#prone_phb).

A creature can use its action to make a DC 10 Strength check, freeing itself or another creature within its reach on a success. The net has AC 10 and 12 hit points. Creatures are no longer [restrained](https://5e.tools/conditionsdiseases.html#restrained_phb) by the net once it drops to 0 hit points.
...
One [guard](https://5e.tools/bestiary.html#guard_mm) patrols this area. Hallways to the north and south connect to area V4.

Alarms. The short hallways that connect this area to the grand entrance ([area V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0)) have [alarm](https://5e.tools/spells.html#alarm_phb) spells cast on them.
...
One [guard](https://5e.tools/bestiary.html#guard_mm) patrols this area. Hallways to the north and south connect to area V3.
...
Alarm. An [alarm](https://5e.tools/spells.html#alarm_phb) spell has been cast on the door that connects this room to [area V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0).

Deadly Doll. After hours, the curator enables her office's defense mechanism: a five-foot-tall doll with the name "Marigold" sewn onto its vintage dress. When a creature other than Alda enters the room, the doll animates and attacks. Marigold uses the [scarecrow](https://5e.tools/bestiary.html#scarecrow_mm) stat block and fights until destroyed.

At your discretion, a noisy fight might attract the attention of the guards patrolling area V1.

Guards' Patrol Routes. If the characters didn't snatch Alda's clutch during the gala, they can find a copy of the guards' after-hours patrol routes on the desk under some other loose paperwork (see the "[Curator Alda Arkin](https://5e.tools/adventure.html#kftgv,1,curator%20alda%20arkin,0)" section).
...
Two [guards](https://5e.tools/bestiary.html#guard_mm) patrol this exhibit and area V10, moving from one room to the other every 5 minutes.

The gems on display here hold little value; precious stones are reserved for display in the Gemstone Wing ([area V13](https://5e.tools/adventure.html#kftgv,1,v13%3a%20gemstone%20wing,0)).
...
Two [guards](https://5e.tools/bestiary.html#guard_mm) patrol both this exhibit and area V9, moving from one room to the other every 5 minutes.
...
Treasure. A character who studies the exhibit and succeeds on a DC 10 Wisdom (Perception) check realizes the items on display include two flawless weapons: a [+1 dagger](https://5e.tools/items.html#%2b1%20dagger_dmg) and a [+1 handaxe](https://5e.tools/items.html#%2b1%20handaxe_dmg). The weapons are inside a glass case with a jammed lock, so the characters must break or cut through the glass to access the weapons. Breaking the glass attracts the guards patrolling this area.
...
Two [guards](https://5e.tools/bestiary.html#guard_mm) patrol this area.

The statue west of the stairs depicts a winged satyr. If a character comes within 5 feet of the statue, it springs to life. The statue uses the [animated armor](https://5e.tools/bestiary.html#animated%20armor_mm) stat block and fights until destroyed.

Alarms. An [alarm](https://5e.tools/spells.html#alarm_phb) spell has been cast in the hallway leading to the Unearthed Café (area V11). Another [alarm](https://5e.tools/spells.html#alarm_phb) spell has been cast on the door in the middle of the east wall (which leads to area V13).
...
As an action, a character can use tinker's tools or thieves' tools to try to overload the magic that powers the controls, doing so with a successful DC 10 Intelligence (Arcana) check. This causes the animatronic creature to break free from its display base and rampage for 10 minutes before becoming inert again. The creature stomps through the area, then heads down the grand staircase, causing mayhem in area V1. While it rampages, the creature uses the [allosaurus](https://5e.tools/bestiary.html#allosaurus_mm) stat block, with these changes:

- The [animatronic allosaurus](https://5e.tools/bestiary.html#animatronic%20allosaurus_kftgv) is a Construct.
- It is immune to poison and psychic damage, as well as the [charmed](https://5e.tools/conditionsdiseases.html#charmed_phb), [frightened](https://5e.tools/conditionsdiseases.html#frightened_phb), [paralyzed](https://5e.tools/conditionsdiseases.html#paralyzed_phb), and [poisoned](https://5e.tools/conditionsdiseases.html#poisoned_phb) conditions.
...
Staff members plan to remove the tables and restore the normal gemstone exhibits in the morning before the museum opens. For now, the contents of those exhibits are in the basement ([area V16](https://5e.tools/adventure.html#kftgv,1,v16%3a%20basement,0)).

Light-Green Stone. The light-green stone on the pedestal is the Murkmire Stone, which is described at the end of this adventure. As Dr. Dannell fears, the stone is indeed an eldritch creature's egg. At 10:30 p.m., the effects described in "[The Murkmire Stone](https://5e.tools/adventure.html#kftgv,1,the%20murkmire%20stone,0)" begin, and at midnight, the egg hatches. See "[Museum Feeding Frenzy](https://5e.tools/adventure.html#kftgv,1,museum%20feeding%20frenzy,0)" to learn what happens when the egg hatches.

Rigged Pedestal. A [detect magic](https://5e.tools/spells.html#detect%20magic_phb) spell reveals an aura of transmutation magic around the pedestal, which is attached to the floor and can't be moved. A character who examines the pedestal notices tiny glyphs carved into its base and can make a DC 12 Intelligence (Arcana) check. On a success, the character realizes that all doors leading to the room will lock if the stone is removed from the pedestal.

If the Murkmire Stone is removed from the pedestal, [arcane lock](https://5e.tools/spells.html#arcane%20lock_phb) spells activate on all doors leading to the room (including secret doors), causing them to close and lock. As an action, a character can try to open a locked door using thieves' tools, doing so with a successful DC 20 Dexterity check, or force open a locked door by succeeding on a DC 20 Strength (Athletics) check. The [arcane lock](https://5e.tools/spells.html#arcane%20lock_phb) spells don't prevent the curator or the museum guards from opening the doors.

Replacing the Murkmire Stone with a fake can prevent the trap from triggering. A suitable fake can be found in [area V9](https://5e.tools/adventure.html#kftgv,1,v9%3a%20underground%20wonders%20exhibit,0). Swapping it for the real Murkmire Stone without activating the [arcane lock](https://5e.tools/spells.html#arcane%20lock_phb) spells requires a successful DC 10 Dexterity (Sleight of Hand) check.

Vent. The west wall has a 3-foot-high, 3-foot-wide, 5-foot-deep air vent leading to [area V12](https://5e.tools/adventure.html#kftgv,1,v12%3a%20prehistoric%20predators%20exhibit,0). The vent is 10 feet above the floor. Reaching it requires a successful DC 10 Strength (Athletics) check. Safely returning to the floor doesn't require an ability check.

Secret Door. The south wall contains a secret door that opens into a short hallway containing cleaning supplies. At the far end of the hallway is another secret door that doesn't require an ability check to spot from inside the hall. This secret door pulls open to reveal the hallway between areas [V9](https://5e.tools/adventure.html#kftgv,1,v9%3a%20underground%20wonders%20exhibit,0) and [V10](https://5e.tools/adventure.html#kftgv,1,v10%3a%20archaeology%20display,0).

### V14: Access Hallway

This hallway connects the Unearthed Café ([area V11](https://5e.tools/adventure.html#kftgv,1,v11%3a%20unearthed%20caf%c3%a9,0)) to the Prehistoric Predators exhibit ([area V12](https://5e.tools/adventure.html#kftgv,1,v12%3a%20prehistoric%20predators%20exhibit,0)) and the privies (area V15).

### V15: Privies

This area holds five stalls. A simple latch allows the door of each privy to be locked from the inside. East of the privies is a staircase to the attic ([area V17](https://5e.tools/adventure.html#kftgv,1,v17%3a%20attic,0)).

### V16: Basement

Boxes and crates are piled here in groups. Enormous warehouse doors take up much of the basement's northern wall.

Objects formerly on display or not yet prepped for display are stored here. The area is infrequently visited, and a [mimic](https://5e.tools/bestiary.html#mimic_mm) recently took up residence in the centermost pile of boxes. The mimic waits to attack until a character moves within 5 feet; it then fights until destroyed.

Loading Docks. The warehouse doors open onto an underground ramp that leads to street level. A character who has observed the whole building from the outside can easily find where the ramp exits at ground level. The doors are locked, and their hinges are stiff. Unlocking them requires a successful DC 14 Dexterity check with thieves' tools; after that, shoving the doors open requires a successful DC 15 Strength (Athletics) check. This is noisy and attracts the attention of one guard patrolling the grand entrance above ([area V1](https://5e.tools/adventure.html#kftgv,1,v1%3a%20grand%20entrance,0)).
...
Museum Feeding Frenzy. The Murkmire Stone hatches into an eight-foot-long, nascent [eldritch horror](https://5e.tools/bestiary.html#eldritch%20horror%20hatchling_kftgv), and the stone's effects cease. At first, the museum's staff assumes someone stole the stone and closes the building. But the hatchling terrorizes and eats the guards one by one. Curator Alda Arkin admits Dr. Dannell's theory might be correct and hires the characters to stop the eldritch creature. The wily monster is now the size of a pony and uses the [ankheg](https://5e.tools/bestiary.html#ankheg_mm) stat block, except its bite deals poison damage instead of acid damage. It has set traps using the slime it secretes while metabolizing its food, and the entire museum is its nightmarish habitat. The characters must stop this creature before it outgrows the museum.

If the eldritch horror isn't defeated within a few days, it rampages through the museum's front doors, bolting toward Varkenbluff University. Now grown to enormous proportions, the [juvenile eldritch horror](https://5e.tools/bestiary.html#juvenile%20eldritch%20horror_kftgv) uses the [behir](https://5e.tools/bestiary.html#behir_mm) stat block but speaks no languages and has an Intelligence score of 18. It also has the following additional action option:
...
2/day each: [blindness/deafness](https://5e.tools/spells.html#blindness%2fdeafness_phb), [blur](https://5e.tools/spells.html#blur_phb)

1/day: [project image](https://5e.tools/spells.html#project%20image_phb)
...
The egg's removal from the Murkmire rapidly accelerated the development of the creature inside it. Starting at 10:30 p.m., the egg's stony shell becomes translucent, revealing the horror inside, and it begins to emit a pulse of magical energy every 10 minutes. Whenever a pulse occurs, each creature within 20 feet of the egg must make a DC 10 Wisdom saving throw, and a creature holding the egg has disadvantage on the roll. If the egg is placed in a [bag of holding](https://5e.tools/items.html#bag%20of%20holding_dmg) or some other portable extradimensional space, the effect radiates from the container instead. Any creature that fails the saving throw is subjected to an effect determined by rolling on the Murkmire Stone Effects table. When a creature rolls for a new effect, the previous one ends. The effects end when the egg hatches or when the egg is encased in the crystal box Dr. Dannell provides.

[![The Murkmire Stone|385](https://5e.tools/img/adventure/KftGV/011-01-005.the-murkmire-stone.webp)](https://5e.tools/img/adventure/KftGV/011-01-005.the-murkmire-stone.webp "The Murkmire Stone. Art credit: Irina Nordsol")
